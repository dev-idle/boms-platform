...
type ManagerCategoryHandler struct {
	usecase *usecase.ManagerCategoryUsecase
}

func NewManagerCategoryHandler(uc *usecase.ManagerCategoryUsecase) *ManagerCategoryHandler {
